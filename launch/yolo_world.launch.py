...
def generate_launch_description():
    ...
    image_width_launch_arg = DeclareLaunchArgument(
        "yolo_world_image_width", default_value=TextSubstitution(text="640")
    )
    image_height_launch_arg = DeclareLaunchArgument(
        "yolo_world_image_height", default_value=TextSubstitution(text="640")
    )
    ...
    if camera_type == "usb":
        ...
        mipi_node = IncludeLaunchDescription(
            ...
            launch_arguments={
                'mipi_image_width': LaunchConfiguration('yolo_world_image_width'),
                'mipi_image_height': LaunchConfiguration('yolo_world_image_height'),
